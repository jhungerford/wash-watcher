/* 
Constants and functions for the LSM6DS3 board.

C adaptation of [Sparkfun's arduino library](https://github.com/sparkfun/SparkFun_LSM6DS3_Arduino_Library/blob/master/src/SparkFunLSM6DS3.h)
...
status_t readRegisterRegion(LSM6DS3Core*, uint8_t*, uint8_t, uint8_t );

//readRegister reads one 8-bit register
status_t readRegister(LSM6DS3Core*, uint8_t*, uint8_t);

//Reads two 8-bit regs, LSByte then MSByte order, and concatenates them.
//  Acts as a 16-bit read operation
status_t readRegisterInt16(LSM6DS3Core*, int16_t*, uint8_t offset );

//Writes an 8-bit byte;
status_t writeRegister(LSM6DS3Core*, uint8_t, uint8_t);

//Change to embedded page
status_t embeddedPage(LSM6DS3Core*);

//Change to base page
status_t basePage(LSM6DS3Core*);
...
int16_t readRawAccelX(LSM6DS3*);
int16_t readRawAccelY(LSM6DS3*);
int16_t readRawAccelZ(LSM6DS3*);
int16_t readRawGyroX(LSM6DS3*);
int16_t readRawGyroY(LSM6DS3*);
int16_t readRawGyroZ(LSM6DS3*);

//Returns the values as floats.  Inside, this calls readRaw___(LSM6DS3*, ;
float readFloatAccelX(LSM6DS3*);
float readFloatAccelY(LSM6DS3*);
float readFloatAccelZ(LSM6DS3*);
float readFloatGyroX(LSM6DS3*);
float readFloatGyroY(LSM6DS3*);
float readFloatGyroZ(LSM6DS3*);

//Temperature related methods
int16_t readRawTemp(LSM6DS3*);
float readTempC(LSM6DS3*);
float readTempF(LSM6DS3*);

//FIFO stuff
void fifoBegin(LSM6DS3*);
void fifoClear(LSM6DS3*);
int16_t fifoRead(LSM6DS3*);
uint16_t fifoGetStatus(LSM6DS3*);
void fifoEnd(LSM6DS3*);

float calcGyro(LSM6DS3*, int16_t);
float calcAccel(LSM6DS3*, int16_t);
